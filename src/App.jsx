...
function App() {
  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<h1>HOLA</h1>} /> //Página de inicio
        <Route path="/login" element={<Login />} /> //Inicio de sesión
        <Route path="/register" element={<Register />} /> //Registro de usuario
        <Route path="/profile" element={<h1>HOLA</h1>} /> //Perfil del usuario
        <Route path="/about" element={<h1>HOLA</h1>} /> //Acerca de
        <Route path="/flats" element={<h1>HOLA</h1>} /> //Listado de pisos
        ...
        <Route path="*" element={<h1>HOLA</h1>} />   //Página no encontrada
      </Routes>
    </BrowserRouter>
  )
}
